...
- Namespace-agnostic parsing (matched by local element name); the message, group, statement, entry and transaction models expose the source `XElement` for fields not mapped to strongly typed properties.
