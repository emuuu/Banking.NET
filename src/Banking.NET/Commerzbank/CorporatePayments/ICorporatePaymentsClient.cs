...
public interface ICorporatePaymentsClient
{
    ...
    /// <summary>Submits an order from a stream. Content that already starts with the gzip magic bytes is sent as `application/gzip` and never compressed again, regardless of <paramref name="compress"/>.</summary>
