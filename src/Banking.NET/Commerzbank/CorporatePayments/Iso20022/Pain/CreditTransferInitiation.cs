...
/// <summary>A pain.001 customer credit transfer initiation message, ready to be written by <see cref="Pain001Writer"/>.</summary>
public sealed class CreditTransferInitiation
{
    ...
    /// <summary>The party that initiated the message (<c>GrpHdr/InitgPty</c>). The name is at most 70 characters in schema version .03 and 140 in .09.</summary>
    ...
    public List<CreditTransferPaymentInformation> PaymentInformations { get; set; } = [];
