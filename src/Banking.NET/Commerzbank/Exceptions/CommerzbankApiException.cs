...
/// <summary>Thrown for a Commerzbank API response with an unsuccessful status code that is not covered by a more specific exception.</summary>
public class CommerzbankApiException : CommerzbankException
{
    /// <summary>Initializes a new instance with a message only.</summary>
    /// <param name="message">The exception message.</param>
    public CommerzbankApiException(string message) : base(message)
    {
    }
    ...
    public CommerzbankApiException(string message, HttpStatusCode? statusCode, string? correlationId, string? rawResponse, Exception? innerException = null)
